  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Stefan Stojanovc - IT Manager portfolio.' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'Stefan Stojanovc - IT Manager portfolio.' },
        { hid: 'og:image', property: 'og:image', content: 'demo-share.jpg' },
        { hid: 'og:url', property: 'og:url', content: 'https://stefanst.com/' },
